...
# predict evaluate
python pred_evaluate.py -pred pred/predict__Twitter_s100_t10.joint_train.add_two_loss.p_1_iterate.use_topic.topic_num50.topic_attn.topic_copy.topic_attn_in.topic_words.ntm_warm_up_0.copy.use_ocntm.encoder_attn.seed9527.emb150.vs30000.dec300.20211109-080209__e103.val_loss=1.535.model-0h-18m/predictions.txt -src data/Twitter/test_src.txt -trg data/Twitter/test_trg.txt